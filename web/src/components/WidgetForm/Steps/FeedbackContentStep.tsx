...
const feedbackTypInfo = feedbackTypes[feedbackType];
  ...
  <footer className="flex gap-2 mt-2">
    ...
    <button
      ...
      focus:outline-none hover:ring-2 hover:ring-offset-2 hover:ring-offset-zinc-900 hover:ring-primary-200 transition-colors"



      // className="bg-primary-200 rounded-md border-transparent flex flex-1 justify-center items-center text-sm hover:bg-primary-300 focus:outline-none"
    >Enviar FeedBack
    </button>
